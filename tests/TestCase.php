...
abstract class TestCase extends Orchestra
{
    ...
    protected function defineEnvironment($app): void
    {
        ...
        // assertInertia() verifies the component file actually ships. The sandbox
        // page is a separate root — it must stay out of resources/js/pages, which
        // the `whatsapp-cloud-inertia` tag publishes wholesale.
        $app['config']->set('inertia.testing.page_paths', [
            dirname(__DIR__).'/resources/js/pages',
            dirname(__DIR__).'/resources/js/sandbox',
        ]);
